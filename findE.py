...
for index, row in df.iterrows():
    if row['Class'] == 'E' and not processed_first_in_section:
        ...
        for i in range(1, 11):
            additional_time = before_150s - timedelta(seconds=i * 1800)
...
# Replace all remaining empty values in the "Y" column with "-1"
...
for first_timestamp, last_timestamp, before_150s, additional_timestamps, additional_timestamps2, after_150s in first_last_closest_timestamps:
    ...
    print("---------------------------------------")
    print("Ys adicionais (intervalo 30 minutos antes do Y=0):", additional_timestamps)
    print("---------------------------------------")
    print("Ys a seguir (intervalo 3 minutos depois do Y=0):", additional_timestamps2)
    print("****************************************")

# Save the modified DataFrame to a new CSV file
new_file_path = '9541_2_mod_with_Y.csv'
